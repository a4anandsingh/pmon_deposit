...
<tr>
	<td width="50%" valign="top"  >
        ...
        <tr>
            <td nowrap="nowrap" class="ui-widget-content"><?php echo getRequiredSign('right');?><strong>AA No : </br><span style="color:red;">(Only numeric.)</span></strong></td>
	...
	<td width="50%" valign="top">
		<table width="100%" cellpadding="3" cellspacing="1" class="ui-widget-content" <?php if ($raaValues['RAA_NO']=='') echo 'style="display:none"';?>>
        <tr>
        	<td colspan="2" class="ui-state-default" align="center" style="line-height:20px;">
            	<input style="display:none" type="checkbox" id="isRAA" name="isRAA" 
		...
		<tr class="raa" <?php if ($raaValues['RAA_NO']=='') echo 'style="display:none"';?>>
        	<td nowrap="nowrap" class="ui-widget-content"><strong>RAA No : </br><span style="color:red;">(Only numeric.)</span></strong></td>
            <td class="ui-widget-content">
...
$().ready(function(){
	...
	$("#frmProject").validate({
		rules: {
			...
			"AA_NO" : {required : true, number:true},
