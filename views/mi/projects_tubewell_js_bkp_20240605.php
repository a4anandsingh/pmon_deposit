<script language="javascript" type="text/javascript">
    ...
    $().ready(function () {
        ...
        $('#LA_DATE, #FA_DATE, #DRILLINGWORK_DATE, ' +
            '#HOUSING_PIPE_DATE, #BLIND_PIPE_DATE, ' +
            '#SLOTTED_PIPE_DATE, #SUBMERSIBLE_DATE, ' +
            '#CONTROL_ROOMS_DATE').attr("placeholder", "dd-mm-yyyy").datepicker({
            dateFormat: 'dd-mm-yy',
            changeMonth: true,
            changeYear: true,
            showOtherMonths: true,
    ...
    function saveProject(mode) {
        ...
        if (mode == 2) {
            ...
            selectList.push(Array('DRILLINGWORK_STATUS', 'Select Drilling Work Status', true));
            selectList.push(Array('HOUSING_PIPE_STATUS', 'Select Housing Pipe Status', true));
            selectList.push(Array('BLIND_PIPE_STATUS', 'Select Blind Pipe Status', true));
            selectList.push(Array('SLOTTED_PIPE_STATUS', 'Select Slotted Pipe Status', true));
            selectList.push(Array('SUBMERSIBLE_STATUS', 'Select Submersible Status', true));
        ...
        if (mode == 2) {
			...
			var naFields = new Array(
                'LA_NA', 'FA_NA', 'L_EARTHWORK_NA', 'C_MASONRY_NA', 'K_CONTROL_ROOMS_NA',
				'DRILLINGWORK_NA',
				'HOUSING_PIPE_NA',
				'BLIND_PIPE_NA',
				'SLOTTED_PIPE_NA',
				'SUBMERSIBLE_NA','IP_TOTAL_NA'			
            );
            ...
            if ($('#startInSession').val() == 1) {
                ...
                var arrFields = new Array(
                    "LA_CASES_STATUS", "FA_CASES_STATUS", "DRILLINGWORK_STATUS", "HOUSING_PIPE_STATUS",
                    "BLIND_PIPE_STATUS", "SLOTTED_PIPE_STATUS", "SUBMERSIBLE_STATUS", "CONTROL_ROOMS_STATUS"
                );
    ...
    function enableDisableDate(targetControl, currentValue) {
        ...
        var arrControls = {
            ...
            'DRILLINGWORK_STATUS': 'DRILLINGWORK_DATE',
            'HOUSING_PIPE_STATUS': 'HOUSING_PIPE_DATE',
            'BLIND_PIPE_STATUS': 'BLIND_PIPE_DATE',
            'SLOTTED_PIPE_STATUS': 'SLOTTED_PIPE_DATE',
            'SUBMERSIBLE_STATUS': 'SUBMERSIBLE_DATE',
    ...
    function setEstimationFields(mName, status) {
        ...
        if (mName == 'LA_NA') {
        ...
        }else if (mName == 'DRILLINGWORK_NA') {
            var arrRulesFields = new Array("DRILLINGWORK", "DRILLINGWORK_ACHIEVE");
            var arrDisableFields = new Array("DRILLINGWORK", "DRILLINGWORK_ACHIEVE");
                //, "HIDTXT_DRILLINGWORK_STATUS_ACHIEVE");
            if (status) {
                //disable controls
                arrRulesFields = new Array();
            } else {
                if ($('#startInSession').val() == 1) {
                    //disable achieve controls
                    arrRulesFields = new Array('DRILLINGWORK');
                    arrDisableFields = new Array("DRILLINGWORK_ACHIEVE");
                } else {
                    //enable both controls
                    arrDisableFields = new Array();
                }
        ...
        }else if (mName == 'HOUSING_PIPE_NA') {
            var arrRulesFields = new Array("HOUSING_PIPE", "HOUSING_PIPE_ACHIEVE");
            var arrDisableFields = new Array("HOUSING_PIPE", "HOUSING_PIPE_ACHIEVE");
            //, "HIDTXT_INTAKE_WELL_STATUS_ACHIEVE", "HIDTXT_WATER_STORAGE_TANK_STATUS_ACHIEVE");
            if (status) {
                //disable controls
                arrRulesFields = new Array();
            } else {
                if ($('#startInSession').val() == 1) {
                    //disable achieve controls
                    arrRulesFields = new Array('HOUSING_PIPE');
                    arrDisableFields = new Array("HOUSING_PIPE_ACHIEVE");
                } else {
                    //enable both controls
                    arrDisableFields = new Array();
                }
            }
        }else if (mName == 'BLIND_PIPE_NA') {
            var arrRulesFields = new Array("BLIND_PIPE", "BLIND_PIPE_ACHIEVE");
            var arrDisableFields = new Array("BLIND_PIPE", "BLIND_PIPE_ACHIEVE");
            //, "HIDTXT_INTAKE_WELL_STATUS_ACHIEVE", "HIDTXT_WATER_STORAGE_TANK_STATUS_ACHIEVE");
            if (status) {
                //disable controls
                arrRulesFields = new Array();
                ...
                if ($('#startInSession').val() == 1) {
                    //disable achieve controls
                    arrRulesFields = new Array('BLIND_PIPE');
                    arrDisableFields = new Array("BLIND_PIPE_ACHIEVE");
                } else {
                    //enable both controls
                    arrDisableFields = new Array();
                }
            }
        }else if (mName == 'SLOTTED_PIPE_NA') {
            var arrRulesFields = new Array("SLOTTED_PIPE", "SLOTTED_PIPE_ACHIEVE");
            var arrDisableFields = new Array("SLOTTED_PIPE", "SLOTTED_PIPE_ACHIEVE");
            //, "HIDTXT_INTAKE_WELL_STATUS_ACHIEVE", "HIDTXT_WATER_STORAGE_TANK_STATUS_ACHIEVE");
            if (status) {
                //disable controls
                arrRulesFields = new Array();
                ...
                if ($('#startInSession').val() == 1) {
                    //disable achieve controls
                    arrRulesFields = new Array('SLOTTED_PIPE');
                    arrDisableFields = new Array("SLOTTED_PIPE_ACHIEVE");
                } else {
                    //enable both controls
                    arrDisableFields = new Array();
                }
            }
        }else if (mName == 'SUBMERSIBLE_NA') {
            var arrRulesFields = new Array("SUBMERSIBLE", "SUBMERSIBLE_ACHIEVE");
            var arrDisableFields = new Array("SUBMERSIBLE", "SUBMERSIBLE_ACHIEVE");
            //, "HIDTXT_INTAKE_WELL_STATUS_ACHIEVE", "HIDTXT_WATER_STORAGE_TANK_STATUS_ACHIEVE");
            if (status) {
                //disable controls
                arrRulesFields = new Array();
                ...
                if ($('#startInSession').val() == 1) {
                    //disable achieve controls
                    arrRulesFields = new Array('SUBMERSIBLE');
                    arrDisableFields = new Array("SUBMERSIBLE_ACHIEVE");
                } else {
                    //enable both controls
                    arrDisableFields = new Array();
                }
			...
			//alert(window.arrBlockIds.length);
        ...
        if (mName == 'LA_NA') {
            ...
            enableDisableMilestoneFields("DRILLINGWORK_STATUS", status);
            //enableDisableMilestoneFields("WATER_STORAGE_TANK_STATUS", status);
        } else if (mName == 'HOUSING_PIPE_NA') {
            enableDisableMilestoneFields('HOUSING_PIPE_STATUS', status);
            //enableDisableMilestoneFields('PIPE_DISTRI_STATUS', status);
        } else if (mName == 'BLIND_PIPE_NA') {
            enableDisableMilestoneFields("BLIND_PIPE_STATUS", status);
        } else if (mName == 'SLOTTED_PIPE_NA') {
            enableDisableMilestoneFields("SLOTTED_PIPE_STATUS", status);
        } else if (mName == 'SUBMERSIBLE_NA') {
            enableDisableMilestoneFields("SUBMERSIBLE_STATUS", status);
        } else if (mName == 'K_CONTROL_ROOMS_NA') {
    ...
    function disableAchievement(status) {
        ...
        var arrIntFields = new Array(
            "LA_NO", "LA_NO_ACHIEVE", "LA_COMPLETED_NO_ACHIEVE", "C_PIPEWORK", "C_PIPEWORK_ACHIEVE",
            "C_DRIP_PIPE", "C_DRIP_PIPE_ACHIEVE", "C_WATERPUMP", "C_WATERPUMP_ACHIEVE", "K_CONTROL_ROOMS",
            "K_CONTROL_ROOMS_ACHIEVE","SUBMERSIBLE","SUBMERSIBLE_ACHIEVE"
        );
        var chkna = '';
        chkna = 'IP_TOTAL_NA';
        mystatus = false;
