                ...
                <tr>
                    ...
                    foreach($arrTargetData as $key=>$targetDatum) {
                        ...
                        $arrMonthTarget = array(
                            ...
                            array(
                                'NAME' => 'DRILLINGWORK',
                                'VALUE' => $arrTargetData[$key]->DRILLINGWORK,
                                'TYPE' => $showHidden,
                                'MONTH' => $a,
                                'COL_WIDTH' => $colWidth,
                                'SHOW' => (($arrSetupData['DRILLINGWORK_NA'] == 0) ? 1 : 0)
                            ),
                            ...
                            array(
                                'NAME' => 'HOUSING_PIPE',
                                'VALUE' => $arrTargetData[$key]->HOUSING_PIPE,
                                'TYPE' => $showHidden,
                                'MONTH' => $a,
                                'COL_WIDTH' => $colWidth,
                                'SHOW' => (($arrSetupData['HOUSING_PIPE_NA'] == 0) ? 1 : 0)
                            ),
                            array(
                                'NAME' => 'BLIND_PIPE',
                                'VALUE' => $arrTargetData[$key]->BLIND_PIPE,
                                'TYPE' => $showHidden,
                                'MONTH' => $a,
                                'COL_WIDTH' => $colWidth,
                                'SHOW' => (($arrSetupData['HOUSING_PIPE_NA'] == 0) ? 1 : 0)
                            ...
                            array(
                                'NAME' => 'SLOTTED_PIPE',
                                'VALUE' => $arrTargetData[$key]->SLOTTED_PIPE,
                                'TYPE' => $showHidden,
                                'MONTH' => $a,
                                'COL_WIDTH' => $colWidth,
                                'SHOW' => (($arrSetupData['SLOTTED_PIPE_NA'] == 0) ? 1 : 0)
                            ),
                            array(
                                'NAME' => 'SUBMERSIBLE',
                                'VALUE' => $arrTargetData[$key]->SUBMERSIBLE,
                                'TYPE' => $showHidden,
                                'MONTH' => $a,
                                'COL_WIDTH' => $colWidth,
                                'SHOW' => (($arrSetupData['SUBMERSIBLE_NA'] == 0) ? 1 : 0)
                            ),
                            array(
                    ...
                    showArrayValues($arrSetupData);
                    exit;*/
                    //showArrayValues($arrTargetBlockData);

                    //echo 'hiiiii === '. $arrTargetBlockData["2017-11-01"][71]->KHARIF;
                    //exit;
                    if($arrSetupData['IP_TOTAL_NA']==1){
                        $arrBlockIps = array();
                    }
                  ...
                  <td align="center" class="ui-state-default" id="DRILLINGWORK_T">&nbsp;</td>
                  <td align="center" class="ui-state-default" id="C_MASONRY_T">&nbsp;</td>

                  <td align="center" class="ui-state-default" id="HOUSING_PIPE_T">&nbsp;</td>
                  <td align="center" class="ui-state-default" id="BLIND_PIPE_T">&nbsp;</td>
                  <td align="center" class="ui-state-default" id="SLOTTED_PIPE_T">&nbsp;</td>
                  <td align="center" class="ui-state-default" id="SUBMERSIBLE_T">&nbsp;</td>
                  ...
                  <td align="center" class="ui-state-default" id="TOTAL_T">&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="center" class="ui-widget-content" id="DRILLINGWORK_ESTI"><?php echo ($arrSetupData['DRILLINGWORK_NA'])?'':$arrEstimation['DRILLINGWORK'];?></td>

                      <!-- <td align="center" class="ui-widget-content" id="L_EARTHWORK_ESTI">&nbsp;</td> -->

                      <td align="center" class="ui-widget-content" id="C_MASONRY_ESTI"><?php echo ($arrSetupData['C_MASONRY_NA'])?'':$arrEstimation['C_MASONRY'];?></td>

                      <td align="center" class="ui-widget-content" id="HOUSING_PIPE_ESTI"><?php echo ($arrSetupData['HOUSING_PIPE_NA'])?'':$arrEstimation['HOUSING_PIPE'];?></td>
                      
                      <td align="center" class="ui-widget-content" id="BLIND_PIPE_ESTI"><?php echo ($arrSetupData['BLIND_PIPE_NA'])?'':$arrEstimation['BLIND_PIPE'];?></td>

                      <td align="center" class="ui-widget-content" id="SLOTTED_PIPE_ESTI"><?php echo ($arrSetupData['SLOTTED_PIPE_NA'])?'':$arrEstimation['SLOTTED_PIPE'];?></td>

                      <td align="center" class="ui-widget-content" id="SUBMERSIBLE_ESTI"><?php echo ($arrSetupData['SUBMERSIBLE_NA'])?'':$arrEstimation['SUBMERSIBLE'];?></td>
                  ...
                  <tr>
                      ...
                      <td align="center" class="ui-widget-content" id="DRILLINGWORK_ACHIEVE"><?php echo ($arrSetupData['DRILLINGWORK_NA'])?'':$arrAchievement['DRILLINGWORK'];?></td>                      
                      ...
                      <td align="center" class="ui-widget-content" id="HOUSING_PIPE_ACHIEVE"><?php echo ($arrSetupData['HOUSING_PIPE_NA'])?'':$arrAchievement['HOUSING_PIPE'];?></td>

                      <td align="center" class="ui-widget-content" id="BLIND_PIPE_ACHIEVE"><?php echo ($arrSetupData['BLIND_PIPE_NA'])?'':$arrAchievement['BLIND_PIPE'];?></td>

                      <td align="center" class="ui-widget-content" id="SLOTTED_PIPE_ACHIEVE"><?php echo ($arrSetupData['SLOTTED_PIPE_NA'])?'':$arrAchievement['SLOTTED_PIPE'];?></td>

                      <td align="center" class="ui-widget-content" id="SUBMERSIBLE_ACHIEVE"><?php echo ($arrSetupData['SUBMERSIBLE_NA'])?'':$arrAchievement['SUBMERSIBLE'];?></td>
                    ...
                    <tr>
                        <td colspan="17" align="left" class="ui-widget-content">
