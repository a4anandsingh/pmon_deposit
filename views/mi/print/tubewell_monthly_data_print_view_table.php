...
//showArrayValues($arrEstimationData);
...
showArrayValues($arrEstimationData);
echo 'current month';
showArrayValues($arrCurrentMonthData);
echo 'prev month';
showArrayValues($arrPreviousMonthData);
echo 'cfy';
showArrayValues($arrCFY);
echo 'tly';
showArrayValues($arrTLY);*/
...
$arrData = array(
	...
	'DRILLINGWORK'=>array(
		'ESTIMATION'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':	giveComma($arrEstimationData['DRILLINGWORK'], 2)),
		'MONTHLY'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCurrentMonthData['DRILLINGWORK'], 2))),
		'PREV_MONTH'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':giveComma($arrPreviousMonthData['DRILLINGWORK'], 2)),
		'CFY'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['DRILLINGWORK'], 2))),
		'TLY'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':giveComma($arrTLY['DRILLINGWORK'], 2)),
		'TOTAL'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['DRILLINGWORK']+$arrTLY['DRILLINGWORK'], 2)))
	),
	...
	'HOUSING_PIPE'=>array(
		'ESTIMATION'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':giveComma($arrEstimationData['HOUSING_PIPE'], 2)),
		'MONTHLY'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCurrentMonthData['HOUSING_PIPE'], 2))),
		'PREV_MONTH'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':giveComma($arrPreviousMonthData['HOUSING_PIPE'], 2)),
		'CFY'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['HOUSING_PIPE'], 2))),
		'TLY'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':giveComma($arrTLY['HOUSING_PIPE'], 2)),
		'TOTAL'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['HOUSING_PIPE']+$arrTLY['HOUSING_PIPE'], 2)))
	),
	
	
	'BLIND_PIPE'=>array(
		'ESTIMATION'=>(($arrSetupStatus['BLIND_PIPE_NA']) ? 'NA':giveComma($arrEstimationData['BLIND_PIPE'], 2)),
		'MONTHLY'=>(($arrSetupStatus['BLIND_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCurrentMonthData['BLIND_PIPE'], 2))),
		'PREV_MONTH'=>(($arrSetupStatus['BLIND_PIPE_NA']) ? 'NA':giveComma($arrPreviousMonthData['BLIND_PIPE'], 2)),
		'CFY'=>(($arrSetupStatus['BLIND_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['BLIND_PIPE'], 2))),
		'TLY'=>(($arrSetupStatus['BLIND_PIPE_NA']) ? 'NA':giveComma($arrTLY['BLIND_PIPE'], 2)),
		'TOTAL'=>(($arrSetupStatus['BLIND_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['BLIND_PIPE']+$arrTLY['BLIND_PIPE'], 2)))
	),
	
	
	'SLOTTED_PIPE'=>array(
		'ESTIMATION'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':giveComma($arrEstimationData['SLOTTED_PIPE'], 2)),
		'MONTHLY'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCurrentMonthData['SLOTTED_PIPE'], 2))),
		'PREV_MONTH'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':giveComma($arrPreviousMonthData['SLOTTED_PIPE'], 2)),
		'CFY'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['SLOTTED_PIPE'], 2))),
		'TLY'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':giveComma($arrTLY['SLOTTED_PIPE'], 2)),
		'TOTAL'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['SLOTTED_PIPE']+$arrTLY['SLOTTED_PIPE'], 2)))
	),
	
	
	'SUBMERSIBLE'=>array(
		'ESTIMATION'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':giveComma($arrEstimationData['SUBMERSIBLE'], 2)),
		'MONTHLY'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCurrentMonthData['SUBMERSIBLE'], 2))),
		'PREV_MONTH'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':giveComma($arrPreviousMonthData['SUBMERSIBLE'], 2)),
		'CFY'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['SUBMERSIBLE'], 2))),
		'TLY'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':giveComma($arrTLY['SUBMERSIBLE'], 2)),
		'TOTAL'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':(($isBlank)?'':giveComma($arrCFY['SUBMERSIBLE']+$arrTLY['SUBMERSIBLE'], 2)))
	),
...
<tr>
    ...
    <td rowspan="2" class="ui-widget-content"><strong>Earthwork <br />
      (As per Earthwork given in DPR)</strong></td>
    <td colspan="2" class="ui-widget-content"><strong>a. Earthwork</strong></td>
    <td class="ui-widget-content">Th Cum</td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['L_EARTHWORK']['ESTIMATION'];?></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['L_EARTHWORK']['MONTHLY'];?></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['L_EARTHWORK']['PREV_MONTH'];?></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['L_EARTHWORK']['CFY'];?></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['L_EARTHWORK']['TLY'];?></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['L_EARTHWORK']['TOTAL'];?></td>
</tr>
<tr>
  <td colspan="2" class="ui-widget-content"><strong>b. Drilling</strong></td>
  <td class="ui-widget-content">Mtrs</td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['DRILLINGWORK']['ESTIMATION'];?></td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['DRILLINGWORK']['MONTHLY'];?></td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['DRILLINGWORK']['PREV_MONTH'];?></td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['DRILLINGWORK']['CFY'];?></td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['DRILLINGWORK']['TLY'];?></td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['DRILLINGWORK']['TOTAL'];?></td>
  </tr>
<tr>
...
<tr>
    ...
    <td class="ui-widget-content" >Mtrs</td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['HOUSING_PIPE']['ESTIMATION'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['HOUSING_PIPE']['MONTHLY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['HOUSING_PIPE']['PREV_MONTH'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['HOUSING_PIPE']['CFY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['HOUSING_PIPE']['TLY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['HOUSING_PIPE']['TOTAL'];?></td>
</tr>
<tr>
    <td class="ui-widget-content" ><strong>ii. Blind Pipe/Casing Pipe</strong></td>
    <td class="ui-widget-content" >Mtrs</td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['BLIND_PIPE']['ESTIMATION'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['BLIND_PIPE']['MONTHLY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['BLIND_PIPE']['PREV_MONTH'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['BLIND_PIPE']['CFY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['BLIND_PIPE']['TLY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['BLIND_PIPE']['TOTAL'];?></td>
</tr>
<tr>
  <td class="ui-widget-content" ><strong>iii. Slotted Pipe/Screen</strong></td>
  <td class="ui-widget-content" >Mtrs</td>
  <td class="ui-widget-content" align="center" <?php echo $myheight;?>><?php echo $arrData['SLOTTED_PIPE']['ESTIMATION'];?></td>
  <td class="ui-widget-content" align="center"><?php echo $arrData['SLOTTED_PIPE']['MONTHLY'];?></td>
  <td class="ui-widget-content" align="center"><?php echo $arrData['SLOTTED_PIPE']['PREV_MONTH'];?></td>
  <td class="ui-widget-content" align="center"><?php echo $arrData['SLOTTED_PIPE']['CFY'];?></td>
  <td class="ui-widget-content" align="center"><?php echo $arrData['SLOTTED_PIPE']['TLY'];?></td>
  <td class="ui-widget-content" align="center"><?php echo $arrData['SLOTTED_PIPE']['TOTAL'];?></td>
</tr>
<tr>
    <td colspan="2" class="ui-widget-content" ><strong>(c) Pumps/Submersible Pumps/Hand Pumps</strong></td>
    <td class="ui-widget-content" >Numbers</td>
    <td class="ui-widget-content" align="center" <?php echo $myheight;?>><?php echo $arrData['SUBMERSIBLE']['ESTIMATION'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['SUBMERSIBLE']['MONTHLY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['SUBMERSIBLE']['PREV_MONTH'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['SUBMERSIBLE']['CFY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['SUBMERSIBLE']['TLY'];?></td>
    <td class="ui-widget-content" align="center"><?php echo $arrData['SUBMERSIBLE']['TOTAL'];?></td>
</tr>
<tr>
...
$arrTitles = array(
	...
	'DRILLINGWORK_STATUS'=>'Drilling Work',
	'HOUSING_PIPE_STATUS'=>'Housing Pipe',
	'BLIND_PIPE_STATUS'=>'Blind Pipe',
	'SLOTTED_PIPE_STATUS'=>'Slotted Pipe',
	'SUBMERSIBLE_STATUS'=>'Pumps/Submersible Pumps/Hand Pumps',
...
$arrStatus = array();
//showArrayValues($arrComponentStatus); //exit;
foreach($arrFields as $f){
	$arrStatus[$f] = array(
		'TITLE'=>$arrTitles[$f],
		'CURRENT_MONTH'=>	(($arrComponentStatus[$f]==1)? 'NA': (($isBlank)? getWorkStatusOptions(0, 
		$prevMonthStatus[$f]):
		$statusOptions[$arrCurrentMonthData[$f]])),
		'PREV_MONTH'=>		(($arrComponentStatus[$f]==1)? 'NA':
		$statusOptions[$prevMonthStatus[$f]]),
