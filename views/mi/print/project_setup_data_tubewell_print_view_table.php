...
<?php 
//showArrayValues($arrSetupStatus);exit;
...
$arrData = array(
    ...
    'DRILLINGWORK'=>array(
        ...
        'ACHIEVEMENT'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':giveComma($arrAchievementData['DRILLINGWORK'], 2))
    ),
    'HOUSING_PIPE'=>array(
        'ESTIMATION'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':giveComma($arrEstimationData['HOUSING_PIPE'], 2)),
        'ACHIEVEMENT'=>(($arrSetupStatus['HOUSING_PIPE_NA']) ? 'NA':giveComma($arrAchievementData['HOUSING_PIPE'], 2))
    ),
    'DRILLINGWORK'=>array(
        'ESTIMATION'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':giveComma($arrEstimationData['DRILLINGWORK'], 2)),
        'ACHIEVEMENT'=>(($arrSetupStatus['DRILLINGWORK_NA']) ? 'NA':giveComma($arrAchievementData['DRILLINGWORK'], 2))
    ...
    'BLIND_PIPE'=>array(
        ...
        'ACHIEVEMENT'=>(($arrSetupStatus['BLIND_PIPE_NA']) ? 'NA':giveComma($arrAchievementData['BLIND_PIPE'], 2))
    ),
    'SLOTTED_PIPE'=>array(
        'ESTIMATION'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':giveComma($arrEstimationData['SLOTTED_PIPE'], 2)),
        'ACHIEVEMENT'=>(($arrSetupStatus['SLOTTED_PIPE_NA']) ? 'NA':giveComma($arrAchievementData['SLOTTED_PIPE'], 2))
    ),
    'SUBMERSIBLE'=>array(
        'ESTIMATION'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':giveComma($arrEstimationData['SUBMERSIBLE'], 2)),
        'ACHIEVEMENT'=>(($arrSetupStatus['SUBMERSIBLE_NA']) ? 'NA':giveComma($arrAchievementData['SUBMERSIBLE'], 2))
    ),
...
<tr>
    <td rowspan="2" align="center" nowrap="nowrap" class="ui-widget-content"><strong>5</strong></td>
    <td rowspan="2" nowrap="nowrap" class="ui-widget-content"><strong>Earthwork&nbsp;<br />(As per Earthwork given in DPR)</strong></td>
    <td colspan="2" nowrap="nowrap" class="ui-widget-content"><strong>Earthwork</strong></td>
...
<tr>
  <td colspan="2" nowrap="nowrap" class="ui-widget-content"><strong>Drilling</strong></td>
  ...
  <td align="center" class="ui-widget-content"><?php echo $arrData['DRILLINGWORK']['ACHIEVEMENT'];?></td>
</tr>
<tr>
    <td rowspan="5" align="center" class="ui-widget-content"><strong>6</strong></td>
    <td class="ui-widget-content"width="110" rowspan="5"><strong>Masonry/Concrete&nbsp;<br />(As per &quot;C&quot; Masonry section of DPR)</strong></td>
...
<tr>
    <td class="ui-widget-content"rowspan="3"><strong>Pipe<br />Works</strong></td>
    <td class="ui-widget-content" nowrap="nowrap"><strong>i. Housing Pipe </strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['HOUSING_PIPE']['ESTIMATION'];?></td>
    <td align="center" nowrap="nowrap" class="ui-widget-content"><strong>Mtrs</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['HOUSING_PIPE']['ACHIEVEMENT'];?></td>
</tr>
<tr>
    <td class="ui-widget-content" nowrap="nowrap"><strong>ii. Blind Pipe/Casing Pipe</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['BLIND_PIPE']['ESTIMATION'];?></td>
    <td align="center" nowrap="nowrap" class="ui-widget-content"><strong>Mtrs</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['BLIND_PIPE']['ACHIEVEMENT'];?></td>
</tr>
<tr>
  <td class="ui-widget-content"><strong>iii. Slotted Pipe/Screen</strong></td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['SLOTTED_PIPE']['ESTIMATION'];?></td>
  <td align="center" nowrap="nowrap" class="ui-widget-content"><strong>Mtrs</strong></td>
  <td align="center" class="ui-widget-content"><?php echo $arrData['SLOTTED_PIPE']['ACHIEVEMENT'];?></td>
</tr>
<tr>
    <td class="ui-widget-content"colspan="2"><strong>Pumps/Submersible Pumps/Hand Pumps</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['SUBMERSIBLE']['ESTIMATION'];?></td>
    <td align="center" nowrap="nowrap" class="ui-widget-content"><strong>Numbers</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrData['SUBMERSIBLE']['ACHIEVEMENT'];?></td>
</tr>
<tr>
...
<tr>
    ...
    <td class="ui-widget-content" align="center">
        <?php echo '<strong>'. (($arrSetupStatus['IP_TOTAL_NA']==1) ? ' NA ':' ') .'</strong>';?>
    </td>
    <td align="center" nowrap="nowrap" class="ui-widget-content"><strong>Hectares</strong></td>
    <td class="ui-widget-content" align="center">
        <?php echo '<strong>'. (($arrSetupStatus['IP_TOTAL_NA']==1) ? ' NA ':' ') .'</strong>';?>
...
if($arrSetupStatus['IP_TOTAL_NA']!=1){
    if($BLOCK_IP_DATA){
    	$i=0;
...
<?php }?>
  ...
  <tr>
    <td align="center" class="ui-widget-content"><strong>9</strong></td>
    <td class="ui-widget-content"><strong>Drinking Purpose</strong></td>
    <td colspan="3" align="center" class="ui-widget-content">
        <?php 
                echo ( ($arrSetupStatus['DRINKING_PURPOSE'] ==1 )? ' Yes ' : ' No ');
         ?>
    </td>
    </tr>
</table>
...
<tr>
    ...
    <td class="ui-widget-content"><strong>Drilling Work</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrStatusOption[$arrSetupStatusData['DRILLINGWORK_STATUS']];?></td>
    <td align="center" class="ui-widget-content"><?php echo myDateFormat($arrTargetDates['DRILLINGWORK_DATE']);?></td>
</tr>
<tr>
    <td align="center" class="ui-widget-content"><strong>d</strong></td>
    <td class="ui-widget-content"><strong>Housing Pipe</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrStatusOption[$arrSetupStatusData['HOUSING_PIPE_STATUS']];?></td>
    <td align="center" class="ui-widget-content"><?php echo myDateFormat($arrTargetDates['HOUSING_PIPE_DATE']);?></td>
</tr>
<tr>
    <td align="center" class="ui-widget-content"><strong>e</strong></td>
    <td class="ui-widget-content"><strong>Blind Pipe/Casing Pipe</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrStatusOption[$arrSetupStatusData['BLIND_PIPE_STATUS']];?></td>
    <td align="center" class="ui-widget-content"><?php echo myDateFormat($arrTargetDates['BLIND_PIPE_DATE']);?></td>
</tr>
<tr>
    <td align="center" class="ui-widget-content"><strong>f</strong></td>
    <td class="ui-widget-content"><strong>Slotted Pipe/Screen</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrStatusOption[$arrSetupStatusData['SLOTTED_PIPE_STATUS']];?></td>
    <td align="center" class="ui-widget-content"><?php echo myDateFormat($arrTargetDates['SLOTTED_PIPE_DATE']);?></td>
</tr>
<tr>
    <td align="center" class="ui-widget-content"><strong>g</strong></td>
    <td class="ui-widget-content"><strong>Pumps/Submersible pumps/Hand pumps</strong></td>
    <td align="center" class="ui-widget-content"><?php echo $arrStatusOption[$arrSetupStatusData['SUBMERSIBLE_STATUS']];?></td>
    <td align="center" class="ui-widget-content"><?php echo myDateFormat($arrTargetDates['SUBMERSIBLE_DATE']);?></td>
</tr>
<tr>
