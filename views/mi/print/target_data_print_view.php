...
<div id="prjtarget_report">
    ...
    <tr>
        ...
        <th rowspan="3" class="ui-state-default">Earthwork <br /> (As per <br /> "L" Earthwork<br /> section of <br />AA)</th>
        <th colspan="4" class="ui-state-default">Masonry/Concrete <br />(As per "C" Masonry section of AA)</th>
        <th rowspan="3" class="ui-state-default">Building Works<br /> ( As per <br />"K" <br />Building section<br /> of AA) <br />Control Rooms</th>
    ...
    <tr>
        ...
        <th rowspan="2" class="ui-state-default">Water<br />Pumps</th>
    ...
    <tbody>
        ...
        foreach($records as $key => $targetDatum) {
            ...
            $arrMonthTarget = array(
                ...
                array(
                    'NAME'=>'C_PIPEWORK',
                    'VALUE'=> $records[$key]->C_PIPEWORK,
                    'TYPE'=>'text',
                    'MONTH' =>$a,
                    'COL_WIDTH' =>6,
                    'SHOW'=> ( ($setupData['C_PIPEWORK_NA']==0)? 1:0)
                ),
                array(
                    'NAME'=>'C_DRIP_PIPE',
                    'VALUE'=> $records[$key]->C_DRIP_PIPE,
                    'TYPE'=>'text',
                    'MONTH' =>$a,
                    'COL_WIDTH' =>3,
                    'SHOW'=> ( ($setupData['C_DRIP_PIPE_NA']==0)? 1:0)
                ),
                array(
                    'NAME'=>'C_WATERPUMP',
                    'VALUE'=> $records[$key]->C_WATERPUMP,
                    'TYPE'=>'text',
                    'MONTH' =>$a,
                    'COL_WIDTH' =>3,
                    'SHOW'=> ( ($setupData['C_WATERPUMP_NA']==0)? 1:0)
                ),
                array(
