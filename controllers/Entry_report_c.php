...
class Entry_report_c extends Project_library{
	...
	public function index(){
		...
		$data['message'] = '';
		$data['page_heading'] = pageHeading('DEPOSIT PROMON - '. $arrProjectType[1].' Project Entry Reports');
		...
		$this->load->view('pmon_deposit/print/report_index_view', $data);
	}
	/**-------- Report ----------*/
	...
	public function getProjectListGrid(){
		...
		if ($EE_ID==0 && $SE_ID==0 && $CE_ID==0){
			...
			$objFilter->SQL="SELECT 
                    ...
                    a.LOCKED,
                    a.MY_PROJECT_STATUS,
                    OFFICE_EE_ID, OFFICE_SE_ID, OFFICE_CE_ID, IS_MI,HEAD
                FROM(
                        SELECT 
                            ...
                            IF(PROJECT_STATUS<5, \"<span class=\'cus-eye\'></span>\", IF(PROJECT_STATUS=5, \"<span class=\'cus-thumb-up\'></span>\", \"<span class=\'cus-cancel\'></span>\")) as MY_PROJECT_STATUS,
                        ...
                        SELECT
                                ...
                                IF(dep_mi__m_project_setup.WORK_STATUS=5, \"<span class=\'cus-thumb-up\'></span>\", \"<span class=\'cus-cancel\'></span>\")) as MY_PROJECT_STATUS,					
